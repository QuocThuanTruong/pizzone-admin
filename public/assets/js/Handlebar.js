Handlebars.registerHelper('render_pagination', function (page, totalPage) {
...
Handlebars.registerHelper('render_pagination_hotdeal', function (page, totalPage) {
    let currentPage = parseInt(page)
    let previousPage = currentPage - 1
    let nextPage = currentPage + 1
    let lastPage = parseInt(totalPage)
...
Handlebars.registerHelper('render_pagination_voucher', function (page, totalPage) {
    let currentPage = parseInt(page)
    let previousPage = currentPage - 1
    let nextPage = currentPage + 1
    let lastPage = parseInt(totalPage)
...
Handlebars.registerHelper('render_pagination_shipping', function (page, totalPage) {
    let currentPage = parseInt(page)
    let previousPage = currentPage - 1
    let nextPage = currentPage + 1
    let lastPage = parseInt(totalPage)
    ...
    html += '<nav class="float-right" aria-label="..."><ul class="pagination">'
    if (previousPage > 0) {
        html += '<li class="page-item"><a class="page-link" tabindex="-1" onClick="gotoPageShipping('+previousPage+')"><i class="fa fa-arrow-left"></i></a></li>'
    } else {
        html += '<li class="page-item"><a class="page-link" tabindex="-1"><i class="fa fa-arrow-left"></i></a></li>'
    }

    if (currentPage - 1 >= 3) {
        html += '<li class="page-item "><a class="page-link" onClick="gotoPageShipping(1)">1</a></li>'
        html += '.....'
        html += '<li class="page-item "><a class="page-link" onClick="gotoPageShipping('+previousPage+')">'+previousPage+'</a></li>'
        html += '<li class="page-item active"><a class="page-link">'+currentPage+'</a></li>'
    } else if (currentPage === 1){
        html += '<li class="page-item active"><a class="page-link">1</a></li>'
    } else if (currentPage === 2){
        ...
        html += '<li class="page-item "><a class="page-link" onClick="gotoPageShipping(1)">1</a></li>'
        html += '<li class="page-item "><a class="page-link" onClick="gotoPageShipping(2)">2</a></li>'
        html += '<li class="page-item active"><a class="page-link">3</a></li>'
    }

    if (totalPage - currentPage >= 3) {
        html += '<li class="page-item "><a class="page-link" onClick="gotoPageShipping('+nextPage+')">'+nextPage+'</a></li>'
        html += '.....'
        html += '<li class="page-item "><a class="page-link" onClick="gotoPageShipping('+lastPage+')">'+lastPage+'</a></li>'
    } else if (totalPage - currentPage === 2){
        html += '<li class="page-item "><a class="page-link" onClick="gotoPageShipping('+nextPage+')">'+nextPage+'</a></li>'
        html += '<li class="page-item "><a class="page-link" onClick="gotoPageShipping('+lastPage+')">'+lastPage+'</a></li>'
    } else if (totalPage - currentPage === 1){
    ...
    if (nextPage <= lastPage) {
        html += '<li class="page-item"><a class="page-link" onClick="gotoPageShipping('+nextPage+')"><i class="fa fa-arrow-right"></i></a></li></ul></nav>'
    } else {
        html += '<li class="page-item"><a class="page-link"><i class="fa fa-arrow-right"></i></a></li></ul></nav>'
    }
